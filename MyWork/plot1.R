#Exploratory Data Analysis First Project Plot 1 R Script
...
#Plot the histogram changing the color to red and the x/y labels and main to appropriate strings
hist(ourData$Global_active_power,main="Global Active Power",xlab="Global Active Power (kilowatts)",col="red")
